...
//         <form action="https://formspree.io/f/mkgnnadn" className="contact_form grid" method="POST">
//           <div className="contact_inputs grid">
//             <div className="contact_content">
//               <label className="contact_label">Name</label>
//               <input type="text" name="name" className="contact_input" required />
//             </div>
//             <div className="contact_content">
//               <label className="contact_label">Email</label>
//               <input type="email" name="email" className="contact_input" required />
//             </div>
//           </div>
//           <div className="contact_content">
//             <label className="contact_label">Subject</label>
//             <input type="text" name="subject" className="contact_input" required />
//           </div>
//           <div className="contact_content">
//             <label className="contact_label">Message</label>
//             <textarea name="message" cols="0" rows="7" className="contact_input message" required></textarea>
//           </div>
